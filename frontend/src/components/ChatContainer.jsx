...
const ChatContainer = () => {
    ...
    const handleFileUpload = async (e) => {
        ...
        try {
            ...
            setMessages(prev => [...prev, { role: 'assistant', content: `I've read ${file.name}! 📚 You can now ask me questions about it.` }]);
        } catch (error) {
            console.error(error);
            setMessages(prev => [...prev, { role: 'assistant', content: `Sorry, I couldn't read that file. (${error.message})` }]);
        } finally {
